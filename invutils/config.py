...
COINGECKO_ENDPOINTS: Dict[str, str] = {
    ...
    'price_hist': f"{COINGECKO_BASE_URL}/coins/%s/market_chart",  # f'https://api.coingecko.com/api/v3/coins/{id_gecko}/market_chart'
}
...
DEFILLAMA_ENDPOINTS: Dict[str, str] = {
    ...
    'price_hist': f"{DEFILLAMA_BASE_COINS_URL}/prices/historical/%s/%s",  # f'https://coins.llama.fi/prices/historical/{timestamp}/{id_llama}'
}